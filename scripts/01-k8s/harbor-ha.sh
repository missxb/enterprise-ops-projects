...
echo "  创建harbor数据库和用户:"
echo "    CREATE DATABASE harbor_registry;"
echo "    CREATE USER harbor WITH PASSWORD '${HARBOR_DB_PASSWORD}';"
echo "    GRANT ALL PRIVILEGES ON DATABASE harbor_registry TO harbor;"
